    ...
    case 'compass':
      return (
        <svg {...common}>
          ...
          <circle cx="44" cy="44" r="34" fill={paper} stroke="rgba(10,10,10,0.08)" />
          <circle cx="44" cy="44" r="26" fill="#FFFFFF" stroke="rgba(10,10,10,0.08)" />
          <path d="M44 20 L48 44 L44 68 L40 44 Z" fill={ink} opacity="0.85" />
          <path d="M20 44 L44 40 L68 44 L44 48 Z" fill={bronze} opacity="0.7" />
          <circle cx="44" cy="44" r="2.4" fill={ink} />
          <text x="44" y="16" textAnchor="middle" fontFamily="Fraunces, serif" fontSize="8" fill={ink} opacity="0.6">N</text>
        </svg>
      );
    case 'book-open':
      return (
        <svg {...common}>
          {/* open ledger with ruled pages */}
          <path d="M12 22 L44 28 L44 72 L12 68 Z" fill="#FFFFFF" stroke="rgba(10,10,10,0.1)" />
          <path d="M76 22 L44 28 L44 72 L76 68 Z" fill="#FFFFFF" stroke="rgba(10,10,10,0.1)" />
          <path d="M44 28 L44 72" stroke="rgba(10,10,10,0.12)" />
          {[36, 42, 48, 54, 60].map(y => (
            <g key={y}>
              <line x1="18" y1={y} x2="40" y2={y + 0.4} stroke={ink} strokeWidth="0.7" opacity="0.18" strokeLinecap="round" />
              <line x1="48" y1={y + 0.4} x2="70" y2={y} stroke={ink} strokeWidth="0.7" opacity="0.18" strokeLinecap="round" />
            </g>
          ))}
